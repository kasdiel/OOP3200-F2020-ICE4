...
int main()
{
	...
	std::cout << "The angle (in degrees) from the first gameObject to the second gameObject is: " << Vector2D::SignedAngle(gameObject2.GetPosition(), gameObject2.GetPosition()) << std::endl;
	
	std::cout << "--------------------------------------------------------------\n" << std::endl;
	std::cout << "First gameObject Details: " << std::endl;
	std::cout << gameObject1.ToString() << std::endl;

	std::cout << "Second gameObject Details: " << std::endl;
